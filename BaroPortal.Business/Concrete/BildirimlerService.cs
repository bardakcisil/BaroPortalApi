...
{
    public class BildirimlerService : IBildirimlerService
    {
        private readonly IBildirimlerDal _bildirimDal;
        private readonly IConfiguration _configuration;

        public BildirimlerService(IBildirimlerDal bildirimDal, IConfiguration configuration)
        {
