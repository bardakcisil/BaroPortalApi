...
namespace BaroPortal.DataAccess.Migrations
{
    ...
    [Migration("20221205140103_anketler_sorular_cevaplar")]
    partial class anketler_sorular_cevaplar
    {
            ...
            modelBuilder.Entity("BaroPortal.Entities.Concrete.Advertisement.AdvType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2022, 12, 5, 17, 1, 2, 512, DateTimeKind.Local).AddTicks(81),
                            Name = "İş Arıyorum",
                            TypeId = 1
                        },
                        new
